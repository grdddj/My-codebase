...
materials=dlmread("metals_properties.csv", ",", 0, 0);

% Picking the material for the simulation
position=MyRnd(2,length(materials)); % Choosing random material from the list
material="Material"; % Getting the name of the material (with great difficulties)
...
gifFileName= "myFile.gif"; % Having the title corresponding to the chosen material and temperatures
%% MAIN BODY
if satan == 666
