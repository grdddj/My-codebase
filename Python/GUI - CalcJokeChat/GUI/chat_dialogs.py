...
class Dialogs:
    ...
    def show_message_on_top(self, message, colour, font_size, title):
        ...
        message_label = tk.Label(
            message_window, text=message, bg=colour,
            font=("Calibri", font_size), justify="center",
            bd=4, borderwidth=40
        )
        message_label.pack()
...
class NameChangeDialog():
    def __init__(self, parent, old_name):
        ...
        self.submit_button = tk.Button(
            self.dialog_window, text='Submit', bg="lime green",
            font=font, command=self.send)
...
class YesOrNoDialog():
    def __init__(self, parent, title, question):
        ...
        self.label = tk.Label(
            self.dialog_window, text=question,
            font=font, bg="orange", borderwidth=10)
        self.label.pack(in_=top, side=tk.LEFT, fill=tk.BOTH, expand=True)

        self.yes_button = tk.Button(
            self.dialog_window, text='Yes', bg="lime green",
            font=font, command=self.send_yes, borderwidth=5)
        self.yes_button.pack(in_=bottom, side=tk.LEFT)

        self.no_button = tk.Button(
            self.dialog_window, text='No', bg="red",
            font=font, command=self.send_no, borderwidth=5)
