...
import shortcuts_full_gui_helper
...
class ShortcutsGUI(QMainWindow):
    def __init__(self, shortcuts):
        ...
        self.width = 450
        self.height = 500
        self.welcome_text = "Welcome to the keyboard shortcut script!\n" + \
    ...
    def initUI(self):
        ...
        self.stop_button.setStyleSheet("{}{}".format(self.inactive_button_background,
                                                     self.button_font_size))
        self.stop_button.pressed.connect(lambda: self.stop_listening())

        self.start_button = QPushButton('START', self)
        self.start_button.move(self.width - start_stop_button_width,
        ...
        self.start_button.setStyleSheet("{}{}".format(self.inactive_button_background,
                                                      self.button_font_size))
        ...
        for index, mode in enumerate(self.shortcuts.all_modes_list):
            ...
            getattr(self, mode).move(0, text_label_height + index * \
            ...
            getattr(self, mode).pressed.connect(lambda mode=mode: self.set_new_mode_and_reflect_it(mode))
        ...
        overall_height = text_label_height + \
            max(len(self.shortcuts.all_modes_list)*(action_button_height + distance_between_action_buttons),
    ...
    def set_new_mode_and_reflect_it(self, new_mode):
        """
    ...
    def highlight_specific_button(self, button_name):
        """
        ...
        for mode in self.shortcuts.all_modes_list + ["stop_button"]:
            if mode == button_name:
                if mode != "stop_button":
                    getattr(self, mode).setStyleSheet("{}{}".format(self.active_action_button_background,
                                                                    self.button_font_size))
                else:
                    getattr(self, mode).setStyleSheet("{}{}".format(self.active_stop_button_background,
                                                                    self.button_font_size))
            else:
                getattr(self, mode).setStyleSheet("{}{}".format(self.inactive_button_background,
                                                                self.button_font_size))
...
if __name__ == '__main__':
    ...
    # Creating our shortcuts object
    shortcuts_object = shortcuts_full_gui_helper.ShortcutsToShortcuts()

    # Creating the window
    app = QApplication(sys.argv)
    ex = ShortcutsGUI(shortcuts_object)
