...
def animate(left_boundary=0, right_boundary=10, amount_of_points=10):
    ...
    x_list = [
        random.randint(left_boundary, right_boundary) for _ in range(amount_of_points)
    ]
    y_list = [
        random.randint(left_boundary, right_boundary) for _ in range(amount_of_points)
    ]
...
left_boundary_label = tk.Label(
    main_window,
    text="Please enter the left boundary",
    bg="yellow",
    font=("Calibri", 15),
    anchor="nw",
    justify="left",
...
right_boundary_label = tk.Label(
    main_window,
    text="Please enter the right boundary",
    bg="yellow",
    font=("Calibri", 15),
    anchor="nw",
    justify="left",
