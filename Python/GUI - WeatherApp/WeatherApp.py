...
frame_top.place(relx=0.5, rely=0.1, relwidth=0.7, relheight=0.1, anchor="n") # Centering the frame
...
button = tk.Button(frame_top, text="Search", bg="grey", fg="black", font=("Calibri", 15), command=lambda: get_weather(entry.get()))
...
frame_bottom = tk.Frame(root, bg="#42b6f4", bd=10) # Colors can ge also "blue", "red"...
frame_bottom.place(relx=0.5, rely=0.3, relwidth=0.7, relheight=0.6, anchor="n")

label = tk.Label(frame_bottom, bg="yellow", font=("Calibri", 25), anchor="nw", justify="left", bd=4)
